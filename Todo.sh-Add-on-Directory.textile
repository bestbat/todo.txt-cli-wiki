...
** "outline- Plan with an outline, sync your next actions":#outline-plan-with-an-outline
...
h2(#outline-plan-with-an-outline). outline- Plan with an outline, sync your next actions
