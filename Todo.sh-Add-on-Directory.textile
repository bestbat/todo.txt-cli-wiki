...
** "clock - Track time for tasks through GNOME hamster"#todo.sh-hamster-clock
...
h2(#todo.sh-hamster-clock). Track time for tasks through GNOME hamster

This addon allows you to clock in tasks through hamster, the GNOME time tracker.
Just call the command "clock" and enter the task number you want to clock in:
