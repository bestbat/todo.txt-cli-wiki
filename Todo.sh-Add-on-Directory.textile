...
Example:
<pre><code>  $ todo.sh lately    # Lists tasks completed within the last 7 days</code></pre>
<pre><code>  $ todo.sh lately 3  # Lists tasks completed within the last 3 days</code></pre>
