...
** "Add only if unique/doesn't already exist":#addu
...
Instead of just listing one ITEM# you can enter multiple ITEM# and even ranges for any ACTION (that takes a ITEM#).
