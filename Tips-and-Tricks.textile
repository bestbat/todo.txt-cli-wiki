...
p. Now you can type @$ todo ad@&lt;Tab&gt; and Bash will autocomplete to @$ todo add@. Any words that begin with + or @ will be completed using projects or contexts, respectively.

_Note: The Bash completion is "currently being integrated into the main todo.txt distribution":https://github.com/ginatrapani/todo.txt-cli/pull/56._
