Todo.sh plugins let you add new todo.sh actions or change (override) default actions.  Visit the [[Todo.sh Add-on Directory]] to find browse available plugins.

h2. Installing Plugins

Plugins must be installed into the .todo.actions.d sub-directory of your home directory.  Create this directory with the following bash shell commands:
